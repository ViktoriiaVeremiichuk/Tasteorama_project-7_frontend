...
import { removeFavoriteRecipe } from "@/lib/api/clientApi";
import { useAuthStore } from "@/lib/store/authStore";
import type { Recipe } from "@/lib/types/recipe";
import styles from "./RecipeCardFavorite.module.css";

type RecipeCardFavoriteProps = {
  recipe: Recipe;
    ...
    try {
      ...
      if (currentUser) {
        setUser({
          ...currentUser,
          favorites:
            currentUser.favorites?.filter((id) => id !== recipe._id) ?? [],
        });
      }
      ...
      footer={
        isRemoving ? (
          ...
          <div className={styles.buttons}>
            ...
            <button
              type="button"
              className={`${styles.favBtn} ${styles.removeFavBtn}`}
